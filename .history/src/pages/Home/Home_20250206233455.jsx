        ...
        <div className="html_showroom">
            {
                ...
                <div id="preview_wrap" className="preview_wrap">
                    ...
                    <iframe srcDoc={modelResult.html} frameBorder="0" onload="this.style.height=(this.contentWindow.document.body.scrollHeight+20)+'px';" id="html_preview"></iframe> 
