...
const  Home = () => {
    ...
    async function uploadFile(file) {
        ...
        return {url: url, name: file.file.name, size: '100x100', description: file.description};
    }
                                ...
                                return (
                                    <div className="inputs_row" key={'inputRow'+i}>
                                        <div>
                                            ...
                                            <input type="file" id={'fileInput-' + i} accept="image/png, image/jpeg, image/gif" onChange={(e)=>checkImageSize(e)}/>
                                        </div>
