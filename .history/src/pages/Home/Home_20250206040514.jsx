...
const  Home = () => {
    ...
    async function uploadImage(image) {
        // console.log(image)
        const storageRef = ref(storage, `/session/${Date.now()}-${image.name}`);
    ...
    <div className="container_home">
        ...
        <div className="messages_container">
            ...
            <div className="chat_form">
                ...
                <input type="file" multiple onChange={(e)=>setInputFiles(e.target.value)}/>
                <button onClick={(e)=>{uploadImages(inputFiles)}}>Send</button>
            </div>
        </div>
