        ...
        return (
            <div className="inputs_row">
                ...
                <div>
                    ...
                    <input type="text" placeholder="File desctiption" data-file_desc className="file_description"/>
                </div>
        ...
        <div className="container_home">
            <div className="left_side">
                <div className="chat_form">
                    ...
                    <button onClick={()=>{setFileInputsCount(fileInputsCount+1), setInputFiles([...inputFiles, InputRow])}} disabled={fileInputsCount < 10 ? false : true}>Add Inputs</button>
