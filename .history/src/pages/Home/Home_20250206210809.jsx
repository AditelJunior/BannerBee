...
const  Home = () => {
    ...
    function fullScreeHtmlPreview() {
        document.getElementById('html_preview').classList.add("htmlPreviewFullScreen");
    }
  return (
    <div>
        ...
        <div className="html_showroom">
            ...
            <iframe srcDoc={modelResult.html} frameBorder="0" id="html_preview" width='100%' height='600px'><button>X</button></iframe>
        </div>
    </div>
